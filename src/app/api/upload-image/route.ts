  ...
  try {
    ...
    try {
      ...
      if (apiKey && apiSecret) {
        ...
        console.log('[Upload Image] Using Cloudinary SDK with API credentials');
        ...
        console.log('[Upload Image] Using Cloudinary SDK with upload preset');
        uploadResult = await cloudinary.uploader.upload(dataUri, {
      ...
      console.error('[Upload Image] Cloudinary upload error:', {
