	...
	return (
		<article className="group cursor-pointer">
			<div className="relative aspect-[4/3] w-full overflow-hidden rounded-lg bg-gray-100">
				...
				{onToggleSave && (
					<button
						...
						className="absolute right-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-gray-700 shadow transition hover:text-orange-600"
			...
			<div className="mt-3 space-y-2">
				<h3 className="line-clamp-2 text-lg font-semibold text-gray-900 transition-colors group-hover:text-orange-600">
					{title}
				</h3>
